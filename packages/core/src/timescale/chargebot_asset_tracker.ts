...
export interface ChargebotAssetTrackerTable {
...
export type ChargebotAssetTracker = Selectable<ChargebotAssetTrackerTable>

export enum AssetTrackerVariables {
  STATUS = 'status',
}

export enum AssetTrackerTagStatus {
  UNKNOWN = "UNKNOWN",
  PRESENT = "PRESENT",
  ABSENT = "ABSENT",
}
