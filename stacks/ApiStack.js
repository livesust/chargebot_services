import { Config, Api, Bucket, use } from "sst/constructs";
...
export function ApiStack({ app, stack }) {
    ...
    const { cognito, cognitoAdminRole, COGNITO_USER_POOL_ID, COGNITO_EMAIL_PHONE_USER_POOL_ID, } = use(CognitoStack);
    ...
    const iamRole = new Role(stack, "ApiRole", {
