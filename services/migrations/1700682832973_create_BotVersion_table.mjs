...
export async function up(db) {
  ...
  await db.schema
    .createTable("bot_version")
    .addColumn("id", "serial", (col) => col.primaryKey())
    .addColumn("version_number", "varchar(255)", (col) => col.notNull().unique())
    .addColumn("version_name", "varchar(255)", (col) => col.notNull().unique())
    .addColumn("notes", "text")
                .addColumn("active_date", "timestampz")
